...
namespace Geta.EpiCategories
{
    public class DefaultContentInCategoryLocator : IContentInCategoryLocator
    {
        ...
        public virtual IEnumerable<T> GetDescendents<T>(ContentReference contentLink, ContentCategoryList categories) where T : ICategorizableContent, IContent
        {
            return GetDescendents<T>(contentLink, categories, CreateDefaultListLoaderOptions());
        }

        public virtual IEnumerable<T> GetDescendents<T>(ContentReference contentLink, ContentCategoryList categories, CultureInfo culture) where T : ICategorizableContent, IContent
        {
        ...
        public virtual IEnumerable<T> GetDescendents<T>(ContentReference contentLink, ContentCategoryList categories, LoaderOptions loaderOptions) where T : ICategorizableContent, IContent
        {
        ...
        public virtual IEnumerable<T> GetChildren<T>(ContentReference contentLink, ContentCategoryList categories, CultureInfo culture) where T : ICategorizableContent, IContent
        {
            var loaderOptions = new LoaderOptions { LanguageLoaderOption.Specific(culture) };
            return GetChildren<T>(contentLink, categories, loaderOptions);
        }

        public virtual IEnumerable<T> GetChildren<T>(ContentReference contentLink, ContentCategoryList categories, LoaderOptions loaderOptions) where T : ICategorizableContent, IContent
        {
            return ContentLoader
